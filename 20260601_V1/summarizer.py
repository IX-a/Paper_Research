...
def summarize(full_text: str, api_key: str, model: str = "deepseek-v4-flash", max_retries: int = 3) -> str:
    client = OpenAI(api_key=api_key, base_url="https://api.deepseek.com")

    text = _truncate_text(full_text)
    messages = [{"role": "user", "content": SUMMARIZE_PROMPT.format(full_text=text)}]
